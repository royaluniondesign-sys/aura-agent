...
@aura_tool(
    ...
    parameters={
        "action": {
            "type": "str",
            "description": "Action: type/click/hotkey/scroll/focus_window/open_app/screen_click/etc",
        },
        "text": {
            "type": "str",
        ...
        "keys": {
            "type": "str",
            "description": "Hotkey combo e.g. 'command+c'",
            "optional": True,
        },
        "key": {
            "type": "str",
            "description": "Single key name e.g. 'enter'",
            "optional": True,
        },
        "direction": {
            "type": "str",
        ...
        "type": {
            "type": "str",
            "description": "Data type for random_data (name/email/phone/password/etc)",
            "optional": True,
        },
    },
)
